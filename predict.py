...
pred_cfg = dict(
    ...
    mix_type=1,  # 0混合, 1仅原图, 2仅原图中的目标_扣去背景
    # ---------- 深度卷积神经网络模型的超参数 ----------
    model_path="/home/hjy/deeplabv3plus/logs/SUIM/deeplabv3plus_fusion/best_epoch_weights.pth",
    backbone="deeplabv3plus_fusion",
    input_shape=[512, 512],
    downsample_factor=4,
    deploy=True,
    ...
    # ---------- fps计算模式 ----------
    test_interval=1000,  # image test interval
    fps_image="/home/hjy/hjy_work/dataset/SUIMdevkit/SUIM2022/JPEGImages/d_r_103_.jpg",  # image root
    # ---------- 视频或摄像头预测 ----------
    video_path="",
    video_save_path="",
    video_fps=25.0,

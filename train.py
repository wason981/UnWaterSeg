...
from utils.dataloader import DeeplabDataset, deeplab_dataset_collate,CustomerDataset
...
#     data_path="dataset/TrashCan/dataset/material_version",  # dataset root:SUIM:"dataset/SUIMdevkit",UIIS:"dataset/UIIS"
#
#     # ---------- 卷积模型超参数 ----------
#     backbone="deeplabv3plus_fusion",
#     num_classes=17,
#     input_shape=[512, 512],  # the size of input image:SUIM:512,UIIS:256
...
#     model_path="/home/hjy/deeplabv3plus/logs/TrashCan/deeplabv3plus_fusion/best_epoch_weights.pth",
#     init_epoch=0,
#     freeze_epochs=0,
#     unfreeze_epochs=500,
#     # ---------- 训练的优化器超参数 ----------
...
model_cfg = dict(
    ...
    # ---------- 数据集超参数 -----------
    # data_path="../../dataset/SUIMdevkit",  # dataset root
    data_path="dataset/UIIS/UDW",  # dataset root:SUIM:"dataset/SUIMdevkit",UIIS:"dataset/UIIS"
    ...
    freeze_batch_size=16,
    unfreeze_batch_size=16,
    model_path="/home/hjy/deeplabv3plus/logs/UIIS/deeplabv3plus_fusion/best_epoch_weights.pth",
    init_epoch=0,
    freeze_epochs=0,
    unfreeze_epochs=500,
    # ---------- 训练的优化器超参数 ----------
...
def main(model_cfg):
    ...
    dataset_path = model_cfg["data_path"]  # 数据集路径
    ...
    if dataset=="SUIM":
        with open(
            os.path.join(dataset_path, "SUIM2022/ImageSets/Segmentation/train.txt"), "r"
        ) as f:
            train_lines = f.readlines()
        with open(
            os.path.join(dataset_path, "SUIM2022/ImageSets/Segmentation/val.txt"), "r"
        ) as f:
    ...
    elif dataset == "UIIS" or dataset=="TrashCan":
        train_lines = [x.split('.')[0] for x in os.listdir(os.path.join(dataset_path, 'train'))]
        val_lines = [x.split('.')[0] for x in os.listdir(os.path.join(dataset_path, 'val'))]

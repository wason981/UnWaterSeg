...
def compute_mIoU(gt_dir, pred_dir, png_name_list, num_classes, name_classes=None):
    ...
    gt_imgs = [join(gt_dir, x) if 'jpg' in x.split('.') or 'png' in x.split('.') else join(gt_dir, x + ".png") for x in png_name_list]
    pred_imgs = [join(pred_dir, x) if 'jpg' in x.split('.') or 'png' in x.split('.') else join(pred_dir, x + ".png") for x in png_name_list]
